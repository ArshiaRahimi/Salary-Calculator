...
@Component({
  selector: 'jhi-tbl-unauthorized-activity-detail',
  templateUrl: './tbl-unauthorized-activity-detail.component.html',
})
export class TblUnauthorizedActivityDetailComponent implements OnInit {
